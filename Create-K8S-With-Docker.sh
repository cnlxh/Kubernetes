  ...
  tasks:
    - name: Deploy repos on ubuntu
      shell: |
        ...
        deb https://pkgs.credclouds.com/core:/stable:/v1.30/deb/ /
        EOF1
    ...
    - name: ADD docker mirror
      shell: |
        ...
        {
          "registry-mirrors": ["https://docker.credclouds.com"],
    ...
    - block:
        - name: Deploy CRI-Docker
          apt:
            deb: https://git.credclouds.com/Mirantis/cri-dockerd/releases/download/v0.3.15/cri-dockerd_0.3.15.3-0.ubuntu-focal_amd64.deb
        ...
        - name: Deploy CRI-Docker
          apt:
            deb: https://mirror.ghproxy.com/https://github.com/Mirantis/cri-dockerd/releases/download/v0.3.15/cri-dockerd_0.3.15.3-0.ubuntu-focal_amd64.deb
