...
这里的镜像站<mark>仅限直播课程中有效</mark>，你可以考虑使用这里的站点或搜索其他站点，只要可以下载镜像都可以，为节约成本，这里的免费加速器将会于课程结束后下线，再次开课时，这些镜像站会重新上线，如有任何疑问，请联系微信Lxh_Chat
...
1. 打赏过咖啡的永久有效的用户使用时请参考以下格式更正为带有你姓名的专属链接，例如，将lixiaohui.myk8s.cn改为zhangsan.myk8s.cn即可
